...
## cambié agente por agenteconjson
from agenteconjson import graph, cargar_tarjetas
from langchain_core.messages import HumanMessage

appconjson = Flask(__name__)
...
@appconjson.route("/", methods=["GET", "POST"])
def index():
    respuesta = None
...
if __name__ == "__main__":
    ##CAMBIÉ app por appconsjon
    appconjson.run(debug=True, host="0.0.0.0", port=5002)
